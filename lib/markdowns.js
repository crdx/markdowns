...
var parser = new argparse({
    add_help: true,
    prog: "markdowns",
    description: "Watch and convert Markdown files into HTML files."
})
...
parser.add_argument("-e", "--extension", { default: "md", help: "set the file extension of Markdown files [default: md]" })
parser.add_argument("-f", "--force", { action: "store_true", help: "ignore warnings" })
parser.add_argument("-n", "--encoding", { default: "utf8", help: "set the file encoding of the output files (ascii or utf8) [default: utf8]" })
parser.add_argument("directory", { default: ".", nargs: "?", help: "directory to process or watch [default: working directory]" })
